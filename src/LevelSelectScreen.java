...
public class LevelSelectScreen {
    ...
    public Rectangle_ verticalSelect = new Rectangle_(100, 400, 200, 100, verticalText, textPosition.middle, font,
            MoColors.black, borderColors, null, gradientFormat.none, 100, 3, true);
    public Rectangle_ horizontalSelect = new Rectangle_(300, 400, 200, 100, horizontalText, textPosition.middle, font,
            MoColors.black, borderColors, null, gradientFormat.none, 100, 3, true);
    public Rectangle_ radialSelect = new Rectangle_(500, 400, 200, 100, radialText, textPosition.middle, font,
            MoColors.black, borderColors, null, gradientFormat.none, 100, 3, true);
    public Rectangle_ increaseSelect = new Rectangle_(200, 570, 35, 35, increaseText, textPosition.middle, font2,
            MoColors.black, borderColors, null, gradientFormat.none, 100, 0, true);
    public Rectangle_ decreaseSelect = new Rectangle_(200, 630, 35, 35, decreaseText, textPosition.middle, font2,
            MoColors.black, borderColors, null, gradientFormat.none, 100, 0, true);
